...
class BaseCipherTest {
    ...
    final void encode() {
        ...
        Assertions
                .assertEquals(cipher.decode(cipher.encode(randomMsg)), randomMsg, "Encoding / Decoding failed");
    }
    ...
    final void decode() {
        ...
        Assertions
                .assertEquals(cipher.encode(cipher.decode(encoded)), encoded, "Encoding / Decoding failed");
    }
