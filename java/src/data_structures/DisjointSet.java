...
class DisjointSet<E> {
    ...
    private void makeSet(final Collection<E> items) {
        items.stream().map(Element<E>::new).forEach(elements::add);
    }

    /**
     * String representation of a {@link DisjointSet}.
     *
    ...
    private class Element<E> {
         ...
         *
         * @param obj object you want to compare this to
         * @return boolean
         */
